...
const MASHUP_NAME = "antigravity.master-border-mu";
...
async function createMashup() {
    ...
    const mashupContent = {
        "UI": {
            "Properties": {
                ...
                "Title": "Master Border Layout Mashup",
                "Area": "Mashup",
                ...
                "Top": 0,
                "Left": 0,
                "Master": "antigravity.Master-mm" // Applying the Master Mashup
            },
            "Widgets": [
                {
                    "Properties": {
                        ...
                        "flex-direction": "column", // Vertical main layout
                        "align-items": "stretch",
                    ...
                    "Widgets": [
                        // 1. TOP CONTAINER (Fixed 100px Height)
                        {
                            "Properties": {
                                ...
                                "DisplayName": "container-top-fixed",
                        ...
                        // 2. MIDDLE ROW (Flexible Height)
                        {
                            "Properties": {
                                ...
                                "flex-direction": "row", // Horizontal layout for Left-Center-Right
                                "align-items": "stretch",
                                "justify-content": "flex-start",
                                "flex-grow": 1,
                                "ResponsiveLayout": true
                            ...
                            "Widgets": [
                                ...
                                // 2b. CENTER CONTAINER (Flexible Width)
                                {
                                    ...
                                    "Widgets": [
                                        // Center Top Container (Hello)
                                        {
                                            "Properties": {
                                                "Type": "flexcontainer",
                                                "__TypeDisplayName": "Responsive Container",
                                                "Id": "flexcontainer-center-top",
                                                "DisplayName": "container-center-top",
                                                "flex-direction": "column",
                                                "align-items": "center",
                                                "justify-content": "center",
                                                "flex-grow": 1,
                                        ...
                                        // Center Bottom Container (World)
                                        {
                                            "Properties": {
                                                "Type": "flexcontainer",
                                                "__TypeDisplayName": "Responsive Container",
                                                "Id": "flexcontainer-center-bottom",
                                                "DisplayName": "container-center-bottom",
                                                "flex-direction": "column",
                                                "align-items": "center",
                                                "justify-content": "center",
                                                "flex-grow": 1,
                        ...
                        // 3. BOTTOM CONTAINER (Fixed 100px Height)
                        {
                            "Properties": {
                                ...
                                "DisplayName": "container-bottom-fixed",
                                "ResponsiveLayout": false,
                                "Height": 100,
                                "MinHeight": 100,
                                "MaxHeight": 100,
    ...
    const payload = {
        "entityType": "Mashups",
        "name": MASHUP_NAME,
        "description": "Master Border Layout Mashup with Hello/World Center",
        "configurationTables": {
            "MobileSettings": {
                "name": "MobileSettings",
                "isHidden": true,
