...
const MASHUP_NAME = "antigravity.slider-transfer-mu";
...
async function createMashup() {
            ...
            "Widgets": [
                {
                    ...
                    "Widgets": [
                            ...
                            "Widgets": [
                                {
                                    "Properties": {
                                        ...
                                        // The user specifically requested text "value"
                                        "LabelText": "value",
                        ...
                        // 2. Bottom Container: Slider Widget (ptcsslider)
                        {
                            "Properties": {
                                "Type": "flexcontainer",
                                "__TypeDisplayName": "Responsive Container",
                                "Id": "flexcontainer-2",
                                "DisplayName": "container-slider",
                                "flex-direction": "column",
                                "align-items": "center",
                                "justify-content": "center",
                                "flex-grow": 1,
                            ...
                            "Widgets": [
                                {
                                    "Properties": {
                                        ...
                                        "StepSize": 1,
                                        "Visible": true,
                                        "ResponsiveLayout": false, // Usually safer for complex widgets
                                        "Width": 300,
                                        "Height": 50
                                    },
                                    "Widgets": []
    ...
    const payload = {
        "entityType": "Mashups",
        "name": MASHUP_NAME,
        "description": "Slider Control Mashup with vertical layout and binding",
        "configurationTables": {
            "MobileSettings": {
                "name": "MobileSettings",
                "isHidden": true,
